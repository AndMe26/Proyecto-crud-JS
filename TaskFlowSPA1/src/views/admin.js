  ...
  <header class="border-b border-blue-100 bg-white/90 backdrop-blur">
    <div class="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
      ...
      <nav class="hidden gap-3 md:flex">
        <a id="go-dashboard" class="rounded-full px-4 py-2 text-sm font-semibold text-slate-600 hover:bg-blue-50 hover:text-blue-700"
        ...
        <a id="go-admin" class="rounded-full bg-blue-600 px-4 py-2 text-sm font-semibold text-white"
