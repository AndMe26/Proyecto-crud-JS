            ...
            <section class="flex items-center justify-center px-6 py-10">
                <div class="w-full max-w-xl rounded-[2rem] border border-blue-100 bg-white p-8 shadow-xl shadow-blue-100/70">
                    <div class="flex items-center justify-between">
                        <a id="go-home" class="text-xl font-black tracking-tight text-blue-900" href="/">TaskFlowSPA</a>
                        <a id="go-register" class="rounded-full border border-blue-200 px-4 py-2 text-sm font-semibold text-blue-700 hover:bg-blue-50" href="/register">Registrarse</a>
                    </div>
                    <div class="mt-8">
