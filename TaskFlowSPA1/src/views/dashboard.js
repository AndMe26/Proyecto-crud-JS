    ...
    <header class="border-b border-blue-100 bg-white/90 backdrop-blur">
        <div class="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
            ...
            <nav class="hidden gap-3 md:flex">
                <a id="go-dashboard" class="rounded-full bg-blue-600 px-4 py-2 text-sm font-semibold text-white"
                href="/src/views/dashboard.js">Dashboard</a>
                <a id="go-tasks" class="rounded-full px-4 py-2 text-sm font-semibold text-slate-600 hover:bg-blue-50 hover:text-blue-700"
                href="/src/views/tasks.html">Tareas</a>
                <a id="go-profile" class="rounded-full px-4 py-2 text-sm font-semibold text-slate-600 hover:bg-blue-50 hover:text-blue-700"
                href="/src/views/profile.html">Perfil</a>
                <a id="go-admin" class="rounded-full px-4 py-2 text-sm font-semibold text-slate-600 hover:bg-blue-50 hover:text-blue-700"
                href="/src/views/admin.html">Admin</a>
                <a class="rounded-full px-4 py-2 text-sm font-semibold text-blue-700 hover:bg-blue-50"
                href="/src/views/login.html">Logout</a>
            </nav>
        </div>
    </header>
            ...
            <section class="mt-8">
                <article class="rounded-3xl border border-blue-100 bg-white p-6 shadow-lg shadow-blue-50">
                    <div class="flex items-center justify-between">
                        ...
                        <a id="go-tasksform" class="rounded-3xl bg-blue-50 p-5 hover:bg-blue-100" href="/src/views/task-form.html">
                            <p class="text-sm font-semibold text-blue-600">Crear</p>
                            <h3 class="mt-2 text-lg font-bold text-slate-900">Nueva tarea</h3>
                        </a>
                        <a id="go-profile" class="rounded-3xl bg-blue-50 p-5 hover:bg-blue-100" href="/src/views/profile.html">
