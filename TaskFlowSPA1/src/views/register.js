      ...
      <section class="flex items-center justify-center px-6 py-10">
        <div class="w-full max-w-xl rounded-[2rem] border border-blue-100 bg-white p-8 shadow-xl shadow-blue-100/70">
          <div class="flex items-center justify-between">
            ...
            <a id="go-login2" class="rounded-full border border-blue-200 px-4 py-2 text-sm font-semibold text-blue-700 hover:bg-blue-50" href="/src/views/login.html">Ya tengo cuenta</a>
          </div>
          ...
          <form id="register-form" class="mt-8 grid gap-5">
            ...
            <a id="go-login" class="inline-flex items-center justify-center rounded-2xl bg-blue-600 px-5 py-3 text-sm font-bold text-white hover:bg-blue-500" href="/src/views/login.html">
              Registrarme
            </a>
          </form>
        </div>
...
export function setupRegister() {
  ...
  const registerButton = document.getElementById('go-login');
